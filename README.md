...
```
git remote set-url origin https://github.com/wxytjustb/devicebeat
...
in the same directory with the name devicebeat.
...
```
./devicebeat -c devicebeat.yml -e -d "*"
```
...
```
mkdir -p ${GOPATH}/src/github.com/wxytjustb/devicebeat
git clone https://github.com/wxytjustb/devicebeat ${GOPATH}/src/github.com/wxytjustb/devicebeat
```
